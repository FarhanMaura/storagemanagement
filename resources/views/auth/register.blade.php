...
<head>
    ...
    <title>Register - Storage Management</title>
...
<body class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300 gradient-bg dark:bg-gray-900">
    ...
    <div id="notificationBubble" class="notification-bubble hidden">
        <div class="glass-effect rounded-2xl shadow-2xl p-6 max-w-sm border-l-4 border-green-400">
            <div class="flex items-start space-x-3">
                <div class="flex-shrink-0">
                    <div class="w-3 h-3 bg-green-400 rounded-full mt-2 animate-pulse"></div>
                </div>
                <div class="flex-1">
                    <h4 class="text-sm font-semibold text-white mb-1">Welcome! 👋</h4>
                    <p class="text-xs text-white/80">Create your account to get started</p>
                </div>
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute top-1/3 right-1/4 w-16 h-16 bg-white/5 rounded-lg animate-float-slow" style="animation-delay: -2s;"></div>
        <div class="absolute bottom-1/4 left-1/3 w-24 h-24 bg-white/8 rounded-full animate-float-slow" style="animation-delay: -4s;"></div>
    ...
    <div class="fade-in max-w-md w-full space-y-8 glass-effect rounded-3xl shadow-2xl p-8 relative overflow-hidden">
        ...
        <div class="text-center relative z-10">
            ...
            <p class="mt-2 text-white/80">Daftar untuk mulai mengelola penyimpanan Anda
</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-6 relative z-10">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <button type="button" onclick="togglePassword('password_confirmation')" class="absolute inset-y-0 right-0 pr-3 flex items-center">
                        <i id="passwordConfirmationIcon" class="fas fa-eye text-white/60 hover:text-white transition-colors"></i>
                    </button>
                </div>
            ...
            <button type="submit"
                ...
                <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                    <i class="fas fa-user-plus text-primary/80 group-hover:text-primary"></i>
                </span>
                {{ __('Create Account') }}
            </button>
        </form>
        ...
        <div class="text-center pt-6 border-t border-white/20 relative z-10">
            <p class="text-sm text-white/60">
                ...
                <a href="{{ route('login') }}" class="font-medium text-white hover:text-white/80 transition-colors duration-200">
                    Sign in here
                </a>
            </p>
        </div>
